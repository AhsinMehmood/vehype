...
class ServiceCancelRequestConfirmationSheet extends StatefulWidget {
  const ServiceCancelRequestConfirmationSheet({
    super.key,
  ...
  @override
  State<ServiceCancelRequestConfirmationSheet> createState() =>
      _ServiceCancelRequestConfirmationSheetState();
}

class _ServiceCancelRequestConfirmationSheetState
    extends State<ServiceCancelRequestConfirmationSheet> {
