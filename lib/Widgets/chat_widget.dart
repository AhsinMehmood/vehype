...
class _ChatWidgetState extends State<ChatWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<GarageModel> garages = garageProvider.garages;
            ...
            return StreamBuilder<OffersModel>(
                ...
                builder: (context, AsyncSnapshot<OffersModel> snapshot) {
                  if (snapshot.hasData && snapshot.data != null) {
                    ...
                    final GarageModel garageModel = garages.firstWhereOrNull(
                            (garage) =>
                                garage.garageId == offersModel.garageId) ??
                        GarageModel(
                            ownerId: '',
                            isCustomModel: false,
                            isCustomMake: false,
                    ...
                    return InkWell(
                      onTap: () {
                        ...
                        ChatController().updateChatTime(
                            userController.userModel!, widget.chat);
                        Get.to(() => MessagePage(
